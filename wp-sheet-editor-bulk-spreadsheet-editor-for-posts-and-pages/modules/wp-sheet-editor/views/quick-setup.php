...
<div class="remodal-bg quick-setup-page-content" id="vgse-wrapper">
	<div class="">
		...
		<div class="setup-screen setup-step active">
			<h2><?php esc_html_e('Welcome to WP Sheet Editor', 'vg_sheet_editor' ); ?></h2>
			<?php do_action('vg_sheet_editor/quick_setup_page/quick_setup_screen/before_content'); ?>
			<p><?php esc_html_e('You can start using the spreadsheet editor in just 5 minutes. Please follow these steps.', 'vg_sheet_editor' ); ?></p>
			...
			$steps = array();
			$steps['enable_post_types'] = '<p>' . esc_html__('Select the information that you want to edit with the spreadsheet editor.', 'vg_sheet_editor' ) . '</p>' . $post_types_form;
			...
			if (!empty($steps)) {
				...
				foreach ($steps as $key => $step_content) {
					...
					echo $step_content; // WPCS: XSS ok.   ?></li>		
					<?php
				}
			...
			<button class="button button-primary button-primary save-all-trigger"><?php esc_html_e('Save and continue', 'vg_sheet_editor' ); ?></button>

			<?php do_action('vg_sheet_editor/quick_setup_page/quick_setup_screen/after_content'); ?>
		</div>

		<div class="modules setup-step">
			<h2><?php esc_html_e('Available components', 'vg_sheet_editor' ); ?></h2>
			<p><?php esc_html_e('The spreadsheet editor is very powerful and it has a lot of features. In this step you can enable the features that you need.', 'vg_sheet_editor' ); ?></p>			
			...
			?>	
			<button class="button button-primary button-primary save-all-trigger"><?php esc_html_e('Continue', 'vg_sheet_editor' ); ?></button> - 
			<button class="button step-back"><?php esc_html_e('Go back', 'vg_sheet_editor' ); ?></button>
		</div>
		<div class="usage-screen setup-step">
			<h2><?php esc_html_e('The Spreadsheet is ready.', 'vg_sheet_editor' ); ?></h2>
			...
			<hr>
			<a class="button settings-button" href="<?php echo esc_url(VGSE()->helpers->get_settings_page_url()); ?>"><i class="fa fa-cog"></i> <?php esc_html_e('Settings', 'vg_sheet_editor' ); ?></a>
			<button class="button step-back"><?php esc_html_e('Go back', 'vg_sheet_editor' ); ?></button>
		...
		<div class="clear"></div>	
		<hr/>
		<p><?php esc_html_e('Tip. We can help you with the spreadsheet setup. Get instant help in the live chat during business hours', 'vg_sheet_editor' ); ?> <a class="button help-button" href="<?php echo esc_url(VGSE()->get_support_links('contact_us', 'url', 'quick-setup-bottom')); ?>" target="_blank" ><i class="fa fa-envelope"></i> <?php esc_html_e('Need help? Contact us', 'vg_sheet_editor' ); ?></a></p>
