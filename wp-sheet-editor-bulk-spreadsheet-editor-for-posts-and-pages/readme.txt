...
== Changelog ==
= V 2.27.0 - 2026-07-09 =
* NEW - COLUMNS MANAGER - Add data validation options
* NEW - CORE - Added "no conflict mode"
* CHANGE - IMPORT - Allow to import XML files
* CHANGE - CORE - Improve UI
* CHANGE - CORE - Improve resiliency of the saving process
* CHANGE - CORE - Performance improvements
* FIX - CORE - Global sort by meta data doesn't work well when having multiple meta filters
* FIX - CORE - Small bug fixes
* FIX - CORE - Security patch
...
* FIX - WPML - Compat issue with WC Multilingual 5.5.0


= V 2.25.18 - 2025-05-23 =
* CHANGE - ACF - Minor improvements
* CHANGE - CORE - UI improvements
* FIX - WPML - The filter "translation missing in language" is not working for languages with dialects
* FIX - WC Products - Small bug fixes
* FIX - CORE - General bug fixes


= V 2.25.17 - 2025-01-28 =
* CHANGE - FORMULAS - Allow to reference columns by name and not just by key
* CHANGE - CORE - Minor UI improvements
* CHANGE - CORE - Updated freemius sdk
* FIX - WC Products - Bug fixes related to exports and imports
